        ...
        children: [
          ...
          GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 16, // Adjust the vertical spacing
              crossAxisSpacing: 16, // Add horizontal spacing
            ),
                  ...
                  switch (index) {
                    case 0:
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QuizPage(quizType: 'Football'),
                        ),
                      );
                      break;
                    case 1:
                    ...
                    case 4:
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QuizPage(quizType: 'Handball'),
                        ),
                      );
                      break;
                    case 5:
                    ...
                    case 6:
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QuizPage(quizType: 'Wrestling'),
                        ),
                      );
                      break;
                    case 7:
