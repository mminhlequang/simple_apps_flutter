...
class MyTheme {
  ...
  static final lightTheme = ThemeData.light().copyWith(
    ...
    textTheme: const TextTheme(
      ...
      bodyMedium: TextStyle(color: Color(0xFF0C91D6)),
    ),
  ...
  static final darkTheme = ThemeData.dark().copyWith(
    ...
    textTheme: const TextTheme(
      ...
      bodyMedium: TextStyle(color: Color(0xFFFADA74)),
      bodySmall: TextStyle(color: Color(0xFFFADA74)),
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: const Color(0xFFFADA74)),
    ),
  );
}
