...
String stringShareImage(url) =>
    '"PicTalks - Premium"\n${"I want share to you this image:".tr()} $url\n${"You can view more at:".tr()} ${Platform.isAndroid ? "https://play.google.com/store/apps/details?id=com.mminhlequang.pictalks" : "https://apps.apple.com/us/app/dreamart-ai/id6480363700?platform=iphone"}';
